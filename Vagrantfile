...
config.vm.define "jenkins" do |jenkins|
  ...
  # Increment IP for Jenkins node
  jenkins.vm.network "private_network", ip: IP_NW + "#{IP_START + NUM_WORKER_NODES + 1}"
  
  # Optional shared folder for Jenkins
  if settings["shared_folders"]
    settings["shared_folders"].each do |shared_folder|
  ...
  jenkins.vm.boot_timeout = 200 # Increase to 3 minutes and 20 seconds

  # Provision Jenkins Node
